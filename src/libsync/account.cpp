...
QUrl Account::deprecatedPrivateLinkUrl(const QByteArray &numericFileId) const
{
    return Utility::concatUrlPath(_userVisibleUrl,
        QLatin1String("/index.php/f/") + QString::fromUtf8(QUrl::toPercentEncoding(QString::fromLatin1(numericFileId))));
}
...
{
    return QStringLiteral("%1/cookies%2.db").arg(QStandardPaths::writableLocation(QStandardPaths::AppConfigLocation), id());
}
